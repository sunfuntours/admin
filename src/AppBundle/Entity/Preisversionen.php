...
class Preisversionen
{
     ...
     * @var integer
     *
     * @ORM\Column(name="pv_max_belegung", type="integer", length=1)
     */
    private $pv_max_belegung = 3;    
    ...
    /**
     * @ORM\OneToMany(targetEntity="TagesPreise", mappedBy="tp_pv_id", indexBy="pv_id", cascade={"persist"})
     */
     ...
     * Add tages_preise
     *
     * @param \AppBundle\Entity\TagesPreise $tagesPreise
     * @return Preisversionen
     */
    public function addTagesPreise(\AppBundle\Entity\TagesPreise $tagesPreise)
    {
        $this->tages_preise[] = $tagesPreise;
     ...
     * @param \AppBundle\Entity\TagesPreise $tagesPreise
     */
    public function removeTagesPreise(\AppBundle\Entity\TagesPreise $tagesPreise)
    {
        $this->tages_preise->removeElement($tagesPreise);
    }
     ...
     * @return \Doctrine\Common\Collections\Collection 
     */
    public function getTagesPreise()
    {
        return $this->tages_preise;
    }
}
